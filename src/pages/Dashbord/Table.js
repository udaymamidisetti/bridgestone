...
export default function StickyHeadTable() {
  ...
  return (
    <Paper sx={{ width: "1039px", overflow: "hidden", marginTop: "36px" }}>
      <TableContainer>
            ...
            {data
              ...
              .map((row, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>
                    {row.status == "true" ? (
                      <label className="bg-green text-white border border-red text-xs p-1  rounded-md">
                        Done
                      </label>
                    ) : (
                      <label className="bg-red-600 text-white text-xs p-1  rounded-md ">
                        Pending
                      </label>
                    )}
                  </TableCell>
